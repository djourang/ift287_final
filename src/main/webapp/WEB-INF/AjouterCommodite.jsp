...
<head>
    ...
    <title>Ajouter Commodité - Gestion de l'Auberge</title>
...
<div class="container">
    ...
    <div class="col-md-6 offset-md-3">
        <form action="AjouterCommoditeServlet" method="POST">
            ...
            <div class="form-group">
                ...
                <input class="form-control" type="number" step="0.01" name="surplusPrix" required>
            </div>
            <div class="row">
                <div class="col-md-6">
                    <input class="btn btn-primary btn-block" type="submit" value="Ajouter Commodité">
                </div>
                <div class="col-md-6">
